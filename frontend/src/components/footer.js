...
export default function Footer() {
  return (
    <footer  className="flex flex-col-reverse text-center lg:flex-row border-t-8 border-darktan pb-8">
      <div className="m-auto pt-12">
        <p className="text-md justify-center text-tan">Fort Collins Horse Boarding Facility</p>
