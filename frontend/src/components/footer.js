  ...
  return (
    <footer className='pt-12' >
      <div className='w-full lg:w-2/3 lg:flex justify-center  content-center m-auto pb-8'>
        <div className='lg:w-1/6 justify-center p-6 lg:mt-12 text-center'>
          <p className='uppercase '>Follow us</p>
              <div className='ml-36 md:ml-[360px] lg:ml-12'>
                <a href='https://www.facebook.com/TaftHillAcres/?ref=hl' aria-label="Head to Facebook to find out more" ><svg className="h-8 w-8 "  viewBox="0 0 24 24"  fill="none"  stroke="rgb(59 130 246)"  strokeWidth="2"  strokeLinecap="round"  strokeLinejoin="round">  <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z" /></svg></a>
              </div>
        </div>
        <div className="w-full lg:w-1/3 p-6 lg:mt-12 lg:mr-8 h-auto text-center">
        
          <h3 className="text-md justify-center text-xl">Fort Collins Horse Boarding Facility</h3>
          <p className='text-center'>Serving the Fort Collins community since 2012</p>
