...
const components = {
  ...
  normal: ({children}) => <p className="text-green  text-2xl">{children}</p>,
  ...
  <Layout>
     ...
     <div className="text-center  h-full w-full md:h-3/4 md:w-3/4 m-auto mb-8">
      <div className="m-auto text-center">
        ...
        <div className="lg:w-3/4 bg-darktan mx-auto p-12">
        <h3 className="text-left text-tan/90  text-2xl">{data.sanityAbout.subtitle}</h3>
      ...
      <div className="lg:w-3/4 bg-darktan mx-auto my-8 p-12">
        <h3 className="text-left text-tan/80 text-2xl">{data.sanityAbout.subtitle2}</h3>
